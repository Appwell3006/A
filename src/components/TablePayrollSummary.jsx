        ...
        <table className='table table-zebra w-full table-auto border-collapse'>
                <thead className='text-center'>
                    <tr>
                        ...
                        <th className='p-2'>Night Differential</th>
                        <th className='p-2'>Rest Day</th>
                        <th className='p-2'>Regular Holiday</th>
                        <th className='p-2'>Special Holiday</th>
                        <th className='p-2'>Straight Duty</th>
                    </tr>
                </thead>
...
export default TablePayrollSummary